...
class EventList : BaseActivity() {
    ...
    private val mColRef = FirebaseFirestore.getInstance().collection("events").orderBy("Date").whereGreaterThan("Date",  Timestamp((System.currentTimeMillis()/1000) - 86400, 0))


    override fun onCreate(savedInstanceState: Bundle?) {
        mActivityTitle = "Upcoming Events"
        ...
        mColRef.get()
            .addOnSuccessListener { collection ->
                if (collection != null) {
                    ...
                    reportError("EVENT LIST ERROR: " + "UNABLE_TO_CONNECT_TO_EVENTS_DATABASE")
                }
            }
            .addOnFailureListener { exception ->
                val e = exception as FirebaseAuthException
                reportError("EVENT LIST ERROR: " + e.errorCode)
            }
    }
    ...
    private fun initRecyclerView(){
        ...
        val adapter = RecyclerViewAdapter(this, mImageAddresses, mTitles, mDates, mSummaries, mDocuments, "Event", newsLinks)
